2   // Import the cds facade object (https://cap.cloud.sap/docs/node.js/cds-facade)
const cds = require('@sap/cds');
require('dotenv');

//The service implementation with all service handlers
const serviceHandlers = async function () {
    ...
    this.after("READ", Risks, (data) => {
        ...
        risks.forEach((risk) => {
            ...
            risk.PrioCriticality = prio_code[risk.prio_code];
        })
    });
...
module.exports = cds.service.impl(serviceHandlers);